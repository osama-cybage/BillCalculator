...
public class CurrencyConverterControllerTest {
    ...
    public void testCalculateBill_Success() throws Exception {
        ...
        when(currencyService.convertAndCalculate(bill)).thenReturn(Optional.of(expectedAmount));
    ...
    public void testCalculateBill_Failure() throws Exception {
        Bill bill = mock(Bill.class);
        when(currencyService.convertAndCalculate(bill)).thenReturn(Optional.empty());
